...
permissions = [
   ...
   Permission(name='Stats Job',    code_name='stats_job',   module_name='Job', module_label='Job Management', description='User can view job statistics'),
        ...
        Permission(name='Show Resume',         code_name='show_resume',         module_name='Resume', module_label='Resume Management',
                   description='User can see the lightweight resume list for tables and dropdowns'),
        Permission(name='Upload Resume',        code_name='upload_resume',        module_name='Resume', module_label='Resume Management',
                   description='User can upload a single resume file'),
        Permission(name='Read Resume',          code_name='read_resume',          module_name='Resume', module_label='Resume Management',
                   description='User can view a resume in full detail'),
        Permission(name='Update Resume',        code_name='update_resume',        module_name='Resume', module_label='Resume Management',
                   description='User can update resume metadata such as name, tags, and notes'),
        Permission(name='Delete Resume',        code_name='delete_resume',        module_name='Resume', module_label='Resume Management',
                   description='User can soft-delete and deactivate a resume'),
        Permission(name='Bulk Upload Resumes',  code_name='bulk_upload_resume',   module_name='Resume', module_label='Resume Management',
                   description='User can bulk upload up to 100 resumes at once and check session status'),
        Permission(name='Retry Parse Resume',   code_name='retry_parse_resume',   module_name='Resume', module_label='Resume Management',
                   description='User can re-trigger AI parsing for failed resumes'),
        Permission(name='Resume Stats',         code_name='stats_resume',         module_name='Resume', module_label='Resume Management',
                   description='User can view resume statistics for the company'),
